...
public class InventoryProvider extends ContentProvider {
    ...
    static {
        ...
        // integer code {@link #INVENTORYS}. This URI is used to provide access to MULTIPLE rows
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case INVENTORY:
                // For the INVENTORYS code, query the inventory table directly with the given
...
// If the weight is provided, check that it's greater than or equal to 0 kg
    ...
    private int updateInventory(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(InventoryEntry.COLUMN_INVENTORY)) {
            // Check that the weight is greater than or equal to 0 kg
            Integer stock = values.getAsInteger(InventoryEntry.COLUMN_INVENTORY);
            if (stock != null && stock < 0) {
                throw new IllegalArgumentException("Inventory requires valid stock");
            }
        }
